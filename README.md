...
User interacts via a menu-driven interface.
Operations like create, search, edit, delete are performed in memory.
Data is saved back to the file before exiting.
🧪 Sample Menu
Address Book Menu:
1. Create contact
2. Search contact
